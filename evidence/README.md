...
|---|---|---|---|---|
| A — Plain isolated input | [Watch](../recordings/A_plain_input.mp4) | Not exported — used the live `diagnose_jank` MCP tool instead | 4,183 samples — summarized in [A_plain_input.md](../scenarios/A_plain_input.md) | Timestamped `adb logcat`, 4 IME cycles — summarized in scenario doc |
...
| A3 — Plain IndexedStack + bottom nav | [Watch](../recordings/A3_plain_indexed_stack.mp4) | `A3_indexed_stack_performance.json` (2,197 frames) | `A3_indexed_stack_cpu_profile.json` (20,910 samples) | Live `diagnose_jank` window only — see scenario doc |
